...
| `targate proxy <start\|stop\|status\|ensure\|setup\|teardown\|cert\|approvals\|approve\|deny>` | Run a registry proxy that vets every package before install (experimental). |
